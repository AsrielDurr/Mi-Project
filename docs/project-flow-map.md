...
| 2. 产品需求定义 | 学生端负责人主笔，三人评审 | 已确认项目全景 | 定义学生主路径、教师操作、服务端结果和验收标准 | `02_product-prd.md` | 草拟用户故事、AC和失败场景 | 保留需求取舍、确认Top需求和Non-goals | 每项需求有可演示AC；一天内可完成 |
...
| 是否进入PRD阶段 | 待批准 | — | 2026-07-16 | 全景图确认后进入 `02_product-prd.md` |
